<x-guest-layout>
    <form method="POST" enctype="multipart/form-data" action="{{ route('register') }}">
        ...
        <div class="mt-4">
            ...
            <x-text-input id="reg_no" class="block mt-1 w-full" type="text" name="reg_no" :value="old('reg_no')"
                          required/>
        ...
        <div class="mt-4">
            ...
            <x-text-input id="campus" class="block mt-1 w-full" type="text" name="campus" :value="old('campus')"
                          required/>
        ...
        <div class="mt-4">
            ...
            <x-text-input id="image" class="block file-input file-input-bordered mt-1 w-full" type="file" name="image"
                          :value="old('image')"
                          required/>
